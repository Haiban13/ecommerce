...
<div class="hidden address-create-popup h-full w-screen flex-col  items-center bg-gray/30 backdrop-blur-sm  fixed  mb-28 z-50  ">
    <div class=" flex h-3/4 w-4/5  flex-col  items-center bg-white  fixed  mb-28 z-50 border-2 border-black rounded-sm  mt-10 md:mt-16">
        <div class="h-10 w-full flex justify-between  items-center border border-b-black">
            <h1 class="ml-4 text-xl ">Add Address</h1>
            <ion-icon name="close-outline" class="w-10 h-full z-50" onclick="setpopup('address-create-popup')"></ion-icon>
        </div>
